 ...
 * @author Jongho Moon
 */
public class Ex8_ConsumerInterceptor implements SimpleAroundInterceptor {
    ...
    public Ex8_ConsumerInterceptor(TraceContext traceContext, MethodDescriptor descriptor, @Name("producerName") MetadataAccessor accessor) {
